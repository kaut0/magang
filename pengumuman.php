...
<?php
	...
	$limit_start = ($page - 1) * $limit;
					...
					// Buat query untuk menampilkan data pengumuman sesuai limit yang ditentukan
	$sql = mysqli_query($kon, "SELECT * FROM pengumuman ORDER BY id DESC LIMIT ".$limit_start.",".$limit);
    ...
    <div class="card">
        <ul class="pagination">
            ...
            <?php
				...
				$sql2 = mysqli_query($kon, "SELECT COUNT(*) AS jumlah FROM pengumuman");
