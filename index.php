...
<main role="main">
    <section class="jumbotron text-left text-white gambar">
        <div class="container">
            ...
            <p style="color: white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste ratione magnam
                    ...
                    <div class="card mb-4 shadow-sm" style="border-radius:20px">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text" style="color:black">
                                ...
                                <li>3. English for teenagers</li>
                                <li>4. General English</li>
                                <li>5. English Conversation</li>
                            </p>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="Registrasi.php" class="btn btn-primary">Daftarkan Diri Anda</a>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 shadow-sm" style="border-radius:20px">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                <center>GROUND STAFF & TOUR TRAVEL</center>
                            </h5>
                            <p class="card-text" style="color:black">
                                <li>1. Ms. Office Profesional</li>
                                <li>2. Graphic Design / Photography</li>
